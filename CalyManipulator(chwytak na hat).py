...
class MalySilnik(object):
    ...
    def __init__(self, _motor_en, _motor_pwm, _motor_dir, _clk, _dt): # parametry Hata oraz AC/DC
    ...
    def UstawieniaSilnika(self): # funkcja ustawiajaca piny
        ...
        GPIO.setup(self.motor_en, GPIO.OUT) #32 - PWM1
...
class X360controler:
    ...
    silnik_chwytak = MalySilnik(23, 13, 25, 20, 21)
    numberOfEngines = 0
    numberOfValues = 2
    stara_pozycja_1 = 0
    stara_pozycja_2 = 0
